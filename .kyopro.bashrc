...
function g() {
    g++ -std=c++23 $1.cpp -I ${MY_KYOPRO_LIBRARY_ROOT} -I ${MY_ATCODER_LIBRARY_ROOT} -I ${MY_BOOST_LIB_ROOT} -I ${MY_EIGEN_LIB_ROOT} -DLOCAL
}

function gon(){
    g++-12 -std=c++23 -I ${MY_KYOPRO_LIBRARY_ROOT} -I ${MY_ATCODER_LIBRARY_ROOT} -I ${MY_BOOST_LIB_ROOT} -I ${MY_EIGEN_LIB_ROOT} -O2 -g -DONLINE_JUDGE -DLOCAL $1.cpp
}

function gof(){
    g++-12 -std=c++23 -I ${MY_KYOPRO_LIBRARY_ROOT} -I ${MY_ATCODER_LIBRARY_ROOT} -I ${MY_BOOST_LIB_ROOT} -I ${MY_EIGEN_LIB_ROOT} -O2 -g -DLOCAL $1.cpp
}
